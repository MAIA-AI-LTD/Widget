function chatWidget(){let i=this;this.config={},this.init=()=>{this.insertChat(),this.loadMessageHistory(),this.autoSizeWidth(),this.sendingToChat(),this.sendingUsingEnter(),this.textareaCancelNewlineOn(),this.textareaAutoSizeWidth(),this.resizeChatWidth(),this.textareaAutoHeight(),this.iconForUnreadMessage.checkNotifLocaleStorage(),this.insertMetaTag()},this.insertChat=t=>{document.head.insertAdjacentHTML("beforeend",'<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500&display=swap" rel="stylesheet">');var e=document.createElement("style"),e=(e.innerHTML=`
